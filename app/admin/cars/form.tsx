  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>Manage your car rental details. Description supports Markdown.</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={onSubmit} className="grid gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <Input id="seats" name="seats" type="number" step="1" min="1" defaultValue={car?.seats} required />
            </div>
            <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-muted-foreground">Tip: Use Markdown for formatting.</p>
          </div>
