...
import { getCarRentalBookingByIdData } from "@/lib/strapi-data";
...
interface CarRentalBookingDetailsPageProps {
  params: Promise<{ id: string }>;
}

export default async function CarRentalBookingDetailsPage({
  params,
}: CarRentalBookingDetailsPageProps) {
  const { id } = await params;
  const booking = await getCarRentalBookingByIdData(id);
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Home className="h-5 w-5" /> Car Rental Booking Details
            </CardTitle>
            <CardDescription>
              Car rental booking information and details
            </CardDescription>
          </CardHeader>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 opacity-50">
              ...
              <div>
                <p className="text-sm font-medium">Rental Start Date</p>
                <p className="text-xs text-muted-foreground">
                  {formatDate(booking.startDate)}
                </p>
              </div>
            ...
            <div className="flex items-center gap-3 opacity-50">
              <div className="w-2 h-2 bg-gray-300 rounded-full"></div>
              <div>
                <p className="text-sm font-medium">Rental End Date</p>
                <p className="text-xs text-muted-foreground">
                  {formatDate(booking.endDate)}
                </p>
              </div>
